...
function TopNavBar({ userType, onLogout }) {
    ...
    return (
        <>
            <nav className="bg-white border-b border-gray-100 fixed w-full z-50 transition-all duration-300 ease-in-out shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-20">
                            ...
                            {currentLinks.map((link) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform origin-left transition-transform duration-300 rounded-full
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            ...
                            <button
                                onClick={onLogout}
                                className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg transition-all duration-300 
                                    hover:bg-blue-700 hover:shadow-lg transform hover:-translate-y-0.5 flex items-center space-x-2"
                            >
                ...
                <div className={`md:hidden transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'max-h-screen' : 'max-h-0 overflow-hidden'}`}>
                    <div className="px-2 pt-2 pb-3 space-y-1 bg-white shadow-lg">
                        ...
                        <button
                            onClick={onLogout}
                            className="w-full mt-4 px-4 py-3 text-base font-medium text-white bg-blue-600 rounded-lg 
