    ...
    return trucks.map(truck => (
      <div key={truck._id} className="flex items-center">
        <input
          ...
          className="mr-2"
        />
        <span>{truck.truckType} - {truck.driverName}</span>
      </div>
    ));
  }
  ...
  return (
    <TruckerLayout>
      <div className="py-8 px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Trucker Dashboard</h1>
              ...
              <div className="mt-12 flex flex-col gap-10 w-full">
                {loading ? (
                  <div className="text-center py-10">
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-600">Loading...</h2>
                  </div>
                ) : (
                  filteredLoads.length > 0 ? (
                    filteredLoads.slice(0, visibleLoads).map((load, index) => (
                      <div key={index} className="bg-sky-800 rounded-t-lg rounded-b-sm shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105">
                        <div className='w-full h-full bg-blue-800'>
                          ...
                          <div className="p-4 sm:p-6 space-y-4 flex-grow bg-white rounded-t-xl rounded-b-sm">
                    ...
                    <div className="text-center py-8 sm:py-10">
                      <h2 className="text-lg sm:text-xl font-semibold text-gray-600">No pending requests found.</h2>
                ...
                {loading ? (
                  ...
                  filteredAcceptedBids.length > 0 ? (
                    filteredAcceptedBids.slice(0, visibleLoads).map((bid, index) => (
                      <div key={index} className="bg-white rounded-t-lg rounded-b-sm shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105">
                    ...
                    <div className="text-center py-8 sm:py-10">
                      <h2 className="text-lg sm:text-xl font-semibold text-gray-600">No accepted bids found.</h2>
                      <p className="text-gray-500 mt-2">Try adjusting your search or filters</p>
                    </div>
                  )
                )}
